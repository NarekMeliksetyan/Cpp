...
Представим, у нас есть сеть из компьютеров, маршрутизаторов(свич) и серверов.
Пусть компьютеров - 20, свичей - 10, серверов - 3.
Устройства соединяются между собой случайно, со следующими условиями:
...
У каждого устройства есть уникальный адрес, который выдается при включении в сеть.
Также, у серверов есть названия: tiktok, snapchat и faceapp.

Компьютеры могут посылать в сеть запросы. Запросы распространяются по следующим законам:
