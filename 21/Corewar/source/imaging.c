...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/05 11:03:33 by dphyliss          #+#    #+#             */
...
void	print_name_champs(t_vm *war)
{
	int		player;
	char	*sub_name;
...
void	print_info_players(t_vm *war)
{
	int player;
